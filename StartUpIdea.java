...
public class StartUpIdea implements Comparable<StartUpIdea> {
     ...
     * @param neededSkills skills needed for startup
     */
    public StartUpIdea(String problem, String targetCustomer,
                       int customerNeed, int knownPeopleWithProblem,
                       int targetMarketSize, String competitors, String neededSkills) {
    ...
    public String toString() {
        ...
        str += "Required Skills: " + requiredSkills + "\n";
        return str;
    }
    ...
    /**
     * Setter for required skills
     * @param requiredSkills to set
     */
